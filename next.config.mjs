    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              process.env.NODE_ENV === "production"
                ? "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' https://image.tmdb.org data:; connect-src 'self' https://api.themoviedb.org; frame-src 'self' https://vidsrc.me https://*.vidsrc.me https://vidsrc.to https://*.vidsrc.to https://vidsrcme.ru https://*.vidsrcme.ru https://vidsrcme.su https://*.vidsrcme.su https://vidsrc-embed.me https://*.vidsrc-embed.me https://vidsrc-embed.ru https://*.vidsrc-embed.ru https://vidsrc-embed.su https://*.vidsrc-embed.su https://vsrc.su https://*.vsrc.su https://vidsrc.cc https://*.vidsrc.cc https://vidsrc.pro https://*.vidsrc.pro https://moviesapi.club https://*.moviesapi.club https://embed.su https://*.embed.su https://autoembed.cc https://*.autoembed.cc https://multiembed.mov https://*.multiembed.mov https://2embed.cc https://*.2embed.cc https://streamsrc.cc https://*.streamsrc.cc; font-src 'self' data:; base-uri 'self'; form-action 'self';"
